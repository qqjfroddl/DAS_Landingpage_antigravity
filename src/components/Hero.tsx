    ...
    <section className="relative min-h-[921px] flex items-center px-8 lg:px-24 overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-wrap gap-6">
          <button className="px-10 py-5 bg-gradient-to-r from-primary to-on-primary-container text-surface font-headline font-extrabold rounded-md shadow-[0_0_20px_rgba(0,218,243,0.1)] hover:shadow-[0_0_30px_rgba(0,218,243,0.2)] transition-all">
            기술력 확인하기
          </button>
          <button className="px-10 py-5 border border-outline-variant text-on-background font-headline font-bold hover:bg-surface-container-high transition-colors">
            기업 브로슈어
          </button>
        </div>
      </motion.div>
